...
namespace SC_VSCode.Commands
{
    ...
    public class CommandManager
    {
        ...
        private static int ResolveAttack(Actor attacker, Actor defender, StringBuilder attackMessage)
        {
            ...
            int hits = 0;
            attackMessage.AppendFormat("\n {0} attacks {1}. ", attacker.Name, defender.Name);
        ...
        private static int ResolveDefense(Actor defender, int hits, StringBuilder attackMessage, StringBuilder defenseMessage)
        {
            ...
            if(hits > 0)
            {
                ...
                attackMessage.AppendFormat("\n scoring {0} hits. ", hits);
                defenseMessage.AppendFormat("\n {0} defends and rolls: ", defender.Name);
        ...
        private static void ResolveDamage(Actor defender, int damage)
        {
            if(damage > 0)
            {
                ...
                GameLoop.UIManager.MessageLog.Add($"\n {defender.Name} was hit for {damage} damage.");
        ...
        private static void ResolveDeath(Actor defender)
        {
            ...
            {
                GameLoop.UIManager.MessageLog.Add($" {defender.Name} was defeated and dropped {defender.Gold} gold coins.");
            }
        }
    }
}