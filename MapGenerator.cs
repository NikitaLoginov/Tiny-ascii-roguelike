...
namespace SC_VSCode
{
    ...
    public class MapGenerator
    {
        // empty constructor
        public MapGenerator(){}
        Map _map; // temporarily stores map worked on
        public Map GenerateMap(int mapWidth, int mapHeight, int maxRooms, int minRoomSize, int maxRoomSize)
        {
            ...
            Random randNum = new Random(); //use better number generator algorythm!
            ...
            for (int i = 0; i < maxRooms; i++)
            {
                ...
                // check if the new room intersect with other rooms already generated
